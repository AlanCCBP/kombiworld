...
export default function TermsAndConditions() {
  return (
    <main className="p-6 sm:p-12 space-y-12 items-center justify-items-center bg-white">
      ...
      <section className="text-[#FF6666]">
        <ul>
          ...
          <li className="flex items-center gap-2">
            <CheckCircle className="text-[#FF6666] w-5 h-5" />
            Nos reservamos el derecho de cancelar el servicio que no tenga reservaciones realizadas
            una hora antes de la salida del servicio desde Suipacha.
          </li>
          <li className="flex items-center gap-2">
            <CheckCircle className="text-[#FF6666] w-5 h-5" />
